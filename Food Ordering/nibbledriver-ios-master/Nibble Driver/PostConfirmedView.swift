...
class PostConfirmedView: UIView {
	...
	func commonInit() {
		...
		let attributedString = NSMutableAttributedString(string: "You can accept or ignore incoming orders from your dashboard.")
